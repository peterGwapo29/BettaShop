...
INSERT INTO `orders`
    (`order_id`, `first_name`, `last_name`, `email`, `order_date`, `country`, `total_value`)
VALUES
    ('BB-2026-00042', 'Jamie', 'Rivera', 'REPLACE_WITH_YOUR_TEST_EMAIL@example.com', '2026-08-15 10:32:00', 'United States', 149.99);
...
--     (`order_id`, `first_name`, `last_name`, `email`, `order_date`, `country`, `total_value`)
-- VALUES
--     ('BB-2026-00017', 'Jamie', 'Rivera', 'REPLACE_WITH_YOUR_TEST_EMAIL@example.com', '2026-06-02 14:05:00', 'United States', 89.50);
